        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <br>
                    <p class="text-gray-400">Want the admin password? Why don't you try guessing it?</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-2">Email: akuma.plot@gmail.com</p>
                    <p class="text-gray-400">Phone: +62 877 3021 3412</p>
                </div>
            </div>
